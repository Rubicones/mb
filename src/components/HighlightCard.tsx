...
export default function HighlightCard({ project }: { project: Project }) {
    return (
        <>
            <div className='hidden md:flex  w-[700px] h-[550px] bg-black rounded-2xl justify-start overflow-hidden relative hover:outline-6 hover:outline-[#C8B936] transition-all duration-200'>
                ...
                <div className='w-1/3 flex flex-col gap-4 font-light p-6 text-xl bg-black'>
                    <div className='flex flex-col'>
                        ...
                        <span className='text-white'>{project.Category.slice(2)}</span>
                    </div>
                    <div className='flex flex-col'>
            ...
            <div className='flex relative md:hidden w-[300px] aspect-[calc(9.5/16)] flex-col bg-black rounded-2xl justify-start overflow-hidden'>
